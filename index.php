...
<body>
	<form>
		...
		<table border=1 width='80%'>
			<tr>
				<td>
					<button type='button' id="BestChoice">優勢</button>
					<p>
			...
			<tr>
				<td>
					<p>
					<button type='button' id="VISD">展望</button>
				</td>
			</tr>
			<tr>
				<td>
...
<script type="text/javascript">
 	$(document).ready(function(){
 		...
 		$("#VISD").on("click",function(){
 			alert("轉換展望資料");
 			document.location.href="VISD.php";   
 		});

		$("#COOPER").on("click",function(){
 			document.location.href="COOPER.php?DT="+$("#DT").val(); 
 		});
